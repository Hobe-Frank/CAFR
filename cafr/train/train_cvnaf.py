...
if __name__ == '__main__':
    ...
    shutil.copyfile(os.path.join(os.path.join(moudles_path, 'dataset'), 'cvnaf.py'),
    ...
    # Train
    train_dataset = CVNAFDatasetTrain(data_folder=config.data_folder,
    ...
    if config.sim_sample:
        ...
        query_dataset_train = CVNAFDatasetSim(data_folder=config.data_folder,
                                              split="train",
                                              img_type="query",
        ...
        reference_dataset_train = CVNAFDatasetSim(data_folder=config.data_folder,
                                                  split="train",
                                                  img_type="reference",
