...
from cafr_base.dataset.cvact_random import CVACTDatasetTrain, CVACTDatasetEval
...
class Configuration:
    ...
    gps_dict_path: str = "/root/autodl-tmp/cross_view/CVACT/gps_dict.pkl"  # path to pre-computed distances
    ...
    # Dataset
    data_folder = "/root/autodl-tmp/cross_view/CVACT"
...
if __name__ == '__main__':
    ...
    shutil.copyfile(os.path.join(os.path.join(moudles_path,'dataset'),'cvact_random.py'), "{}/dataset.py".format(model_path))
